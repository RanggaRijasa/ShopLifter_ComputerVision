...
# Model
model = YOLO(r'D:\SHOPLIFTING-DETECTION-USING-YOLOV8\configs\best_new.pt')
...
while True:
    ...
    # ✅ Confidence dinaikkan ke 0.7 agar tidak false positive
    results = model.predict(frame, verbose=False, conf=0.7, iou=0.4)
    ...
    # ✅ Logic rekam — hanya rekam saat shoplifting
    ...
    if recording and writer is not None:
        writer.write(frame)
        # Indikator REC di pojok kanan atas
